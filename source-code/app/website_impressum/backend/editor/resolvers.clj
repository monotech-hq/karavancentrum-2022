...
(ns app.website-impressum.backend.editor.resolvers
...
(defresolver get-content
             ...
             ;  {:website-impressum.editor/get-content (map)}
             [env resolver-props]
             {:website-impressum.editor/get-content (get-content-f env resolver-props)})
